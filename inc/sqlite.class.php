...
if (class_exists("video_checkmark_sqlite")):		// In order to prevent the class to be included multiple times
	die("Please rename this class name to something else.");
else:

	class video_checkmark_sqlite {

		private $db;
		public $tableName;

		function __construct($fileName, $tableName='') {
			$filePath = $_SERVER['DOCUMENT_ROOT'] . "/wp-content/data";
